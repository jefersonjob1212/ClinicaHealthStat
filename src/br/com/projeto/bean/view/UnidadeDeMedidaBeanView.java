...
public class UnidadeDeMedidaBeanView extends BeanManagedViewAbstract {
	
	private static final long serialVersionUID = 1L;
	
	private UnidadeDeMedida objetoSelecionado = new UnidadeDeMedida();
	
	private String url = "/cadastro/cadUnidadeDeMedida.jsf?faces-redirect=true";
	private String urlFind = "/cadastro/findUnidadeDeMedida.jsf?faces-redirect=true";
