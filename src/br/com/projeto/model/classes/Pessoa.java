...
public class Pessoa implements Serializable {
	...
	@Basic
	// Muitas cidades dentro de um paciente
	@ManyToOne
	@JoinColumn(name = "cidade", nullable = false)
	@ForeignKey(name = "idPessoaCidadeFK")
	private Cidade cidade = new Cidade();
	
	@Transient/*Não persisten*/
	...
	/*
	 * @Column(name="pessoaTituloEleitor") private String pessoaTituloEleitor;
	 * 
	 * @Column(name="pessoaAltura") private Double pessoaAltura;
	 * 
	 * @Column(name="pessoaPeso") private Double pessoaPeso;
	 */
	// GETTERS E SETTERS
